...
<html>
	<head>
		...
		<?php if ($_SESSION['legacy'] != true) echo('<link rel="stylesheet" type="text/css" href="/nsr/css/base.css">'); ?>
                <link rel="icon" href="/nsr/img/favicon.ico" type="image/x-icon">
                <link rel="shortcut icon" href="/nsr/img/favicon.ico" type="image/x-icon">
	</head>
